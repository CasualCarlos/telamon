...
- When creating UX specifications or validating implementations against UX specs, use the skill `get-e.ux-design`
...
- Produce implementation-ready interaction guidance following the `get-e.ux-design` skill templates.
- Review implemented UI against UX specs using the `get-e.ux-design` skill validation template.
