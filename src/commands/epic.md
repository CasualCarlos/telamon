...
follow the `telamon.workflow.plan-story` skill for each of the stories in the epic backlog, 
creating a `.ai/telamon/memory/work/active/<epic-folder>/<story-folder>/backlog.md` for each story, 
