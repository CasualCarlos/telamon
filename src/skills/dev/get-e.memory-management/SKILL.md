---
name: get-e.memory-management
description: "Manages the project's MEMORY.md file for capturing, organizing, and applying lessons learned across sessions. Use when recording lessons, pruning stale entries, or consulting memory before starting new work."
---
...
- When MEMORY.md grows beyond 100 entries (prune)

## File Location

`<project-root>/.ai/context/MEMORY.md`

This file is loaded automatically during the bootstrap sequence, so all agents see its contents at session start.
...
1. Read the full MEMORY.md file (it is loaded during bootstrap).
...
When MEMORY.md grows beyond 100 entries or when architecture significantly changes:
