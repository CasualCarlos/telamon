...
- **Any PARTIAL/ADEQUATE/MINOR_ISSUES** = acceptable but note for improvement in MEMORY.md.
- **Any DEVIATED/NONE/GAPS/SIGNIFICANT_ISSUES/MISSING** = follow-up task required before moving on.

## Post-Iteration Retrospective

After all tasks in a backlog are completed (`get-e.workflow.implement-story` skill step 3), the PO produces a retrospective:
...
> - **Action**: <concrete change to make> — record in MEMORY.md under the appropriate category.
>
